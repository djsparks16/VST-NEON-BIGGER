...
juce::AudioProcessorValueTreeState::ParameterLayout ObsidianAudioProcessor::createLayout()
{
    ...
    const juce::StringArray tableNames { "Basic", "Pulse", "User" };
    const juce::StringArray warpANames { "Off", "Sync", "Bend", "Mirror", "FM (Osc B)" };
    const juce::StringArray warpBNames { "Off", "Sync", "Bend", "Mirror" };
